...
def gatherFeaturesAndMakeSIA(start_date, end_date, showPlots):
    ...
    print("Gathering csv data for testing. Please wait...")
    ...
    # Replacing Movement random values with actual values -> UP or DOWN
    i=0
    ...
    print("Finished test data set! Output -> trade.csv.")
