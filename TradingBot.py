...
def clickedGatherTrainData():
    ...
    global thread1
    thread1 = threading.Thread(target=gatheringFeatures.gatherFeaturesAndMakeSIA, args=['2018-04-03', '2018-06-02', False])
    thread1.start()
...
def clickedGatherTestData():
    ...
    global thread2
    thread2 = threading.Thread(target=gatherFeaturesTrade.gatherFeaturesAndMakeSIA, args=['2018-06-03', '2018-07-14', False])
    thread2.start()
...
def clickedTrade():
    ...
    try:
        ...
        messagebox.showerror('Error', 'Invalid arguments')
